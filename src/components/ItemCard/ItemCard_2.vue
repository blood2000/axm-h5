<template>
	<view class="item-card">
		<view class="item-card__title">
			<view class="title-box" @click="handleItem()">
		...
		<view class="item-card__content">
			...
			<view class="item-card__content__block" @click="handleCountDetail">
				...
				<text class="label">累计完成量<text class="has-arrow" /></text>
			</view>
		</view>
...
<script>
	...
	export default {
		...
		mounted() {
			// const now = this.parseTime(new Date(), '{y}-{m}-{d}');
			// this.range = [now, now];
